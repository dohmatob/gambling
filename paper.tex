\documentclass{article} % For LaTeX2e\usepackage{nips14submit_e}
...
Finally, one checks that ${x^*}^TAy^* = {-0.05555}$,
 ...
 analytically by H. W. Kuhn in his 1950 paper \cite{kuhn}. More
 details (payoff matrix, etc.) are provided in the supplementary
 materials. The  evolution of the dual gap and the expected value of
...
avoiding these projections was one of the goals of the present
manuscript.
