...
\textbf{keywords}: sequential game; incomplete information; perfect
...
the primal-dual gap might explode nearly the set of feasible points,
...
$\mathcal{O}(1/\epsilon)$. These contributions will be elaborated in
section \ref{sec:gsp}. %%  The source of approximation in our scheme
...
Let us introduce some powerful modern convex-analytical notions which will be
