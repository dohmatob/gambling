...
entries are $-1$, $0$ or $1$, with exactly 1 entry equal -1 per row, and each $e_k$ is a vector of the form
$(1, 0, ..., 0)$.
...
\label{eq:polytope}
\end{equation}
is the the strategy profile of player $k$ in this representation.
