...
\usepackage[hscale=0.7,vscale=0.8]{geometry}  %% for larger margins
\usepackage{url}
...
\begin{equation}
  \begin{aligned}
    ...
    p\rangle \hspace{.5em}\text{
       subject to: } y \ge 0, E_2y = e_2, -Ay + E_1^Tp \geq 0,
  \end{aligned}
  \label{eq:primal_pb}
\end{equation}
...
\begin{minipage}{.4\linewidth}
  \includegraphics[width=1\linewidth]{polytope.png}
...
\begin{definition}
  ...
  \rightarrow [-\infty,+\infty]$, the $\epsilon$-enlarged subdifferential (or
  $\epsilon$-subdifferential, for short) of $f$ is the set-valued function
  \begin{eqnarray}
