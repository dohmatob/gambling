...
\begin{remark}  
It should be noted that for the the class of games considered here
...
$\epsilon_{n+1} = \epsilon_n / \gamma$ (with $\gamma > 1$)  on
...
one can compute the primal-dual gap between the primal LCP
