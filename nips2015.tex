...
Poker). Our algorithm only performs basic iterations (i.e iterations
...
thanks to the sequence-form representation
\cite{koller1992complexity}. As an application, we apply our algorithm
to solve Kuhn 3-card Poker.
\end{abstract}
...
Consider the following algorithm for solving the GSP \eqref{eq:unconstrained_pb}
\begin{algorithm}
...
The has $n_1 = n_2 = 5$ and $l_1 = l_2 = 3$. Its sequence-form
representation is given by (showing only nonzero entries):\\

 $E_1(0,0) = E_1(1,1) =
E_1(1,2) = E_1(2,3) = E_1(2,4) = \textbf{1}$,
$E_1(1,0) = E_1(2,0) = \textbf{-1}$;\\

$E_2(0,0) = E_2(1,1) = E_2(1,2) = E_2(2,3) = E_2(2,4) = \textbf{1}$,
$E_2(1,0) = E_2(2,0) = \textbf{-1}$; and\\

$A(2,0) = A(4,0) = \textbf{-0.5}$, $A(1,3) = \textbf{1}$, $A(3,1) =
...
$E_1(0,0) = E_1(1,9) = E_1(1,12) = E_1(2,1) = E_1(2,4) = E_1(3,5) =
...
$A(3,8) = A(3,12) = A(4,6) = A(4,10) = A(7,12) = A(8,10) =
